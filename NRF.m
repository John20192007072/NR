clc;clear;
disp('Univeridad Distrital Francisco Jose de Caldas');
disp('Analisis de sistemas de potencia');
disp('DOCENTE:Alexander Narvaez');
disp('Flujo de potencia por el metodo de newton rapson ');
disp('Clasico, Desacoplado , Desacoplado rapido');
disp('INTEGRANTES');
disp('Lizeth Robayo - 20191007010');
disp('John Pinilla - 20192007072');
disp('Cristian Cuervo - 20192007068');
disp('V.1.0');
...
L(k,2)=input('');
fprintf("     N.I   N.F   Rkm   Xkm  Yc/2   ");
L
end
for k=1:lineas
fprintf('para la rama %i ingrese la resistencia\n',k);
L(k,3)=input('');
fprintf('para la rama %i ingrese la reactancia\n',k);
L(k,4)=input('');
...
deltasV
VFinish=Vant+deltasV
fprintf("      #N   Tipo de Nodo   P.G      Q.G.         P.D     Q.D        V      Angulo      ");
 U